...
**Family:** v5 — **Sonnet tier** (lean behind-the-screen surface). **Save-state stamp:** `PROMPT_VERSION: v5-S 20260803b`
...
3. ☐ No PC interiority narrated without asking; §8 mind-incursion fired on the fiction, not the spell name.
